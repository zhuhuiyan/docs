...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/notary/badge/icon) (`i386/notary` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/notary/)
